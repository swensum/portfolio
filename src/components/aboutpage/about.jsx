...
const FACTS = [
  ...
  '6+ months building real products',
      ...
      <section className={`about-section ${isAboutVisible ? 'fade-in' : ''}`}>
        <div className="about-container">
          <div className={`about-image ${isAboutVisible ? 'fade-in' : ''}`}>
            {/* Viewfinder-style corner marks instead of an icon — a quiet
                detail that carries the "framing a shot" idea without
                depending on an extra image asset. */}
            <span className="frame-corner corner-tl" aria-hidden="true" />
            <span className="frame-corner corner-br" aria-hidden="true" />
            <img src={port} alt="Sumit Shrestha" />
          </div>
          ...
          <div className={`about-content ${isAboutVisible ? 'fade-in' : ''}`}>
            ...
            <h2 className="heading">
              <span className="heading-text">Who I Am</span>
              <span className="inline-underline"></span>
            </h2>

            <p className="me">I'm a Developer</p>
            <h2 className="app">
              I build applications that
              <br />
              help people
            </h2>
            <p className="detail">
              I'm a web and app developer based in Nepal, and I take real care in the work I ship.
              In six months of hands-on experience I've picked up the habits that matter most:
              writing code that's easy to maintain, listening closely in discovery calls, and
              staying involved from the first sketch through to launch.
            </p>
            ...
            <div className="about-actions">
              <button type="button" className="cv" onClick={handleViewCV}>
                Download CV
                <svg width="22" height="21" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="cv-icon">
